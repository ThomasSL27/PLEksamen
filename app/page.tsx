...
export default function Page() {
  return (
    <main className="min-h-screen bg-[#111111] overflow-hidden relative">
        ...
        <div className="mx-auto grid max-w-7xl w-full items-center gap-12 pb-12 pt-10 md:pt-16 lg:grid-cols-12 lg:gap-8">
          ...
          <div className="flex flex-col justify-center lg:col-span-7">
            ...
            <h1 className="font-black uppercase tracking-tighter text-white text-6xl sm:text-7xl md:text-8xl lg:text-[6.5rem] xl:text-[7.5rem] leading-[0.85] mb-6">
              <span className="text-[#FF6B00] drop-shadow-[0_0_30px_rgba(255,107,0,0.15)]">POWER</span>
              <br />
              LIGAEN
            </h1>
            ...
            <div className="space-y-2 mt-4">
              <h2 className="text-xl sm:text-2xl md:text-3xl font-black uppercase tracking-tight text-white leading-tight">
                Danmarks <span className="text-[#FF6B00] font-black">største</span> CS2 Liga
              </h2>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-black uppercase tracking-tight text-white leading-tight">
                <span className="text-[#FF6B00] drop-shadow-[0_0_15px_rgba(255,107,0,0.25)] font-black">160.000 KR</span> PÅ HØJKANT
              </h2>
            </div>
          </div>
      ...
      <section className="relative z-10 py-12 sm:py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-8">
            <p className="text-[10px] font-black uppercase tracking-widest text-[#FF6B00] mb-1">
              NYHEDER
            </p>
