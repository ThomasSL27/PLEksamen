...
function FaqItem({ question, answer }: { question: string; answer: string }) {
  ...
  return (
    <div className="border-b border-[#FF6B00]/10 py-5 transition-colors">
      <button
        onClick={() => setIsOpen(!isOpen)}
        className="flex w-full items-center justify-between text-left font-black uppercase tracking-tight text-white hover:text-[#FF6B00] transition-colors focus:outline-none"
      >
        <span className="text-sm sm:text-base">{question}</span>
        <span
          className={`transform transition-transform duration-305 text-[#FF6B00] shrink-0 ml-4 ${
            isOpen ? "rotate-180" : ""
          }`}
        >
      ...
      >
        <div className="overflow-hidden">
          <p className="text-sm text-[#FFD8B1]/70 leading-relaxed max-w-3xl whitespace-pre-line">
            {answer}
          </p>
        </div>
      </div>
...
export default function OmPage() {
  return (
    <main className="min-h-screen bg-[#111111] text-[#ededed] font-sans overflow-hidden relative">
      <div className="relative z-10 mx-auto max-w-5xl px-4 pb-16 pt-8 sm:px-6 sm:pb-24 sm:pt-10">
        ...
        <div className="space-y-16">
          ...
          <section className="space-y-4">
            ...
            <p className="text-sm sm:text-base leading-relaxed text-[#FFD8B1]/70 max-w-3xl">
          ...
          <section className="border-t border-[#FF6B00]/10 pt-10">
            ...
            <h2 className="text-5xl sm:text-7xl font-black uppercase tracking-tighter text-white leading-none">
              <span className="text-[#FF6B00] drop-shadow-[0_0_30px_rgba(255,107,0,0.25)]">160.000 KR.</span>
            </h2>
            <p className="text-xs sm:text-sm font-bold uppercase tracking-widest text-[#FFD8B1]/40 mt-2">
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 gap-10 border-t border-[#FF6B00]/10 pt-10">
            
            {/* POWER Ligaen Præmiefordeling */}
            <div className="space-y-4">
              <div className="border-b border-[#FF6B00]/10 pb-2">
                <h3 className="text-lg font-black uppercase tracking-tight text-white">Power Ligaen</h3>
                <p className="text-[9px] font-bold text-[#FFD8B1]/40 uppercase tracking-widest">Hovedturnering • 100.000 KR.</p>
              </div>
              <ul className="space-y-2.5 text-xs sm:text-sm">
                <li className="flex justify-between items-center text-white font-black uppercase pb-1.5 border-b border-white/[0.03]">
                  <span>1. plads</span>
                  <span className="text-[#FF6B00]">40.000 KR. <span className="text-[10px] text-[#FFD8B1]/55">+ 5.000 kr. i club share</span></span>
                </li>
                <li className="flex justify-between items-center text-white/90 pb-1.5 border-b border-white/[0.03]">
                  <span>2. plads</span>
                  <span>15.000 KR. <span className="text-[10px] text-[#FFD8B1]/45">+ 5.000 kr. i club share</span></span>
                </li>
                <li className="flex justify-between items-center text-white/80 pb-1.5 border-b border-white/[0.03]">
                  <span>3. plads</span>
                  <span>5.000 KR. <span className="text-[10px] text-[#FFD8B1]/45">+ 5.000 kr. i club share</span></span>
                </li>
                <li className="flex justify-between items-center text-white/70 pb-1.5 border-b border-white/[0.03]">
                  <span>4. plads</span>
                  <span>5.000 KR. <span className="text-[10px] text-[#FFD8B1]/45">i club share</span></span>
                </li>
            ...
            <div className="space-y-4">
              <div className="border-b border-[#FF6B00]/10 pb-2">
                ...
                <p className="text-[9px] font-bold text-[#FFD8B1]/40 uppercase tracking-widest">CEPTER divisioner • 60.000 KR.</p>
              </div>
              <ul className="space-y-3.5 text-xs sm:text-sm">
                <li className="flex flex-col gap-0.5 pb-1.5 border-b border-white/[0.03]">
                  ...
                  <div className="flex justify-between text-[#FFD8B1]/80">
                ...
                <li className="flex flex-col gap-0.5 pb-1.5 border-b border-white/[0.03]">
                  ...
                  <div className="flex justify-between text-[#FFD8B1]/80">
                    <span>1. plads: 5.000 KR. <span className="text-[10px] text-[#FFD8B1]/45">(per div)</span></span>
                  </div>
                </li>
                <li className="flex flex-col gap-0.5 pb-1.5 border-b border-white/[0.03]">
                  <span className="font-black text-white uppercase text-xs">3. Division A/B/C/D</span>
                  <div className="flex justify-between text-[#FFD8B1]/80">
                    <span>1. plads: 4.500 KR. <span className="text-[10px] text-[#FFD8B1]/45">(per div)</span></span>
                  </div>
                </li>
                <li className="flex flex-col gap-0.5">
                  <span className="font-black text-white uppercase text-xs">4. Division A/B/C/D</span>
                  <div className="flex justify-between text-[#FFD8B1]/80">
                    <span>1. plads: 3.500 KR. <span className="text-[10px] text-[#FFD8B1]/45">(per div)</span></span>
                  </div>
                </li>
              </ul>
            </div>
          ...
          {/* 4. FAQ Sektion */}
          <section className="border-t border-[#FF6B00]/10 pt-10">
            <h2 className="text-xs font-black uppercase tracking-widest text-[#FF6B00] sm:text-sm mb-4">
